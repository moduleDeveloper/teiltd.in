  ...
  return (
    <LegalPageLayout title="Terms of Service - SETU" updated="May 2026">
      <section>
        ...
        <p className="mt-3">
          SETU is a digital community platform owned and created by Thermal Engineers &amp; Insulators Private Limited (CIN: U74210DL2011PTC220424). Registered Office: 4th Floor, C-57, TEI Tower, Wazirpur Industrial Area, New Delhi - 110052.
        </p>
      </section>
